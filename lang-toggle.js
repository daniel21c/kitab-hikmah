const translations = {
    "id": {
        ...
        "tp_subtitle": "Sebuah Tinjauan dari Sahih Al-Bukhari",
        "tp_intro": "Banyak yang menuduh Injil telah diubah (Tahrif). Namun, apa kata Ibnu Abbas r.a., sepupu Nabi dan ahli tafsir terbesar?",
        "tp_quote_title": "👳‍♂️ Pendapat Abdullah Ibnu Abbas r.a.",
        "tp_quote_text": "Dalam <strong>Sahih Al-Bukhari</strong>, beliau menjelaskan makna \"Tahrif\":",
        "tp_quote_block": "\"Tidak ada seorangpun yang dapat mengubah (menghapus) satu kata pun dari Kitab-kitab Allah. Yang dimaksud dengan 'mengubah' (Tahrif) adalah <strong>mengubah penafsirannya</strong>, bukan mengubah teks aslinya.\"",
        ...
        "tp_citation_full": "📚 <strong>Sumber:</strong> <em>Sahih Al-Bukhari</em>, Kitab At-Tauhid (Book 97), Bab 55.<br>Pandangan ini juga dikuatkan oleh <strong>Imam Ibnu Hajar al-Asqalani</strong> dalam kitab syarah-nya, <em>Fath al-Bari</em>.",
        ...
        "tc_intro": "Membaca Kitab Terdahulu (Taurat & Injil) bukan hanya tradisi modern, namun telah dilakukan oleh ulama-ulama klasik untuk memahami konteks ayat-ayat Al-Quran (Ilmu <em>Munasabah</em>).",
        "tc_biqai_title": "👳‍♂️ Imam Burhan al-Din al-Biqai (Wafat 885 H)",
        "tc_biqai_intro": "Beliau adalah <em>Mufassir</em> agung yang menulis tafsir terkenal <strong>\"Nazm al-Durar\"</strong>. Keunikannya? Beliau secara ekstensif mengutip ayat-ayat Torah dan Injil untuk menunjukkan keserasian (koherensi) dengan Al-Quran. Ketika dikritik, beliau menulis pembelaan berjudul <em>\"Al-Aqwal al-Qawimah\"</em>:",
        "tc_biqai_citation": "📚 <strong>Sumber:</strong> Saleh, Walid. <em>\"In Defense of the Bible\"</em> (Analisis karya Al-Biqai).",
        ...
        "ti_razi_extra": "Dan mengenai \"Kalimat Allah\", beliau menjelaskan bahwa Isa diciptakan langsung dengan perintah <em>\"Kun\"</em> (Jadilah), tanpa perantara ayah manusia, menjadikannya manifestasi langsung dari Kehendak Pencipta.",
        "ti_btn_source": "🔗 Cek di Altafsir.com (Arabic)",
        ...
        "ti_conclusion_text": "Jika Ulama besar mengakui Beliau sebagai \"Sebab Kehidupan Spiritual\" bagi dunia, maka wajar jika Injil dipenuhi dengan ajaran yang menghidupkan hati. Sudahkah Anda meminum dari \"Air Kehidupan\" ini?",
    ...
    "en": {
        ...
        "wr_card1_text": "<p>\"The believers believe in <strong>all the books revealed by Allah</strong> to His Messengers... they do not differentiate between any of them.\"</p>",
        ...
        "wr_card4_text": "<p>\"In the Gospel, there is <strong>guidance to the truth</strong> and a light that dispels the darkness of doubt and problems.\"</p>",
        ...
        "tp_subtitle": "Review from Sahih Al-Bukhari & Classical Tafsir",
        "tp_intro": "Many assume the Scriptures are totally corrupted (Tahrif). However, great scholars distinguish between <strong>Tahrif al-Lafz</strong> (textual corruption) and <strong>Tahrif al-Ma'na</strong> (interpretation corruption). Which one does the Quran mean?",
        "tp_quote_title": "👳‍♂️ Opinion of Abdullah Ibn Abbas r.a.",
        "tp_quote_text": "Ibn Abbas, the Prophet's cousin and <i>Turjuman al-Quran</i>, gives a surprising view in <strong>Sahih Al-Bukhari</strong>:",
        "tp_quote_block": "\"No one can change (erase) a single word from Allah's Books. What is meant by 'changing' (Tahrif) is <strong>changing the interpretation (misinterpretation)</strong>, not changing the original text.\"",
        "tp_conclusion_title": "Why is this Important?",
        "tp_conclusion_text": "If the original text is preserved (QS 6:115), the \"corruption\" is merely misinterpretation by past clergy. This means <strong>the current text still holds \"Light\" and \"Guidance\"</strong> for those who read with a Hanif heart. The Dead Sea Scrolls also prove this preservation.",
        "tp_citation_full": "📚 <strong>Source:</strong> <em>Sahih Al-Bukhari</em>, Manual of Tawhid (Book 97), Chapter 55.<br>This view is also supported by <strong>Imam Ibn Hajar al-Asqalani</strong> in his commentary, <em>Fath al-Bari</em>.",
        ...
        "tc_intro": "Reading Previous Scriptures is not just a modern tradition, but was practiced by classical scholars to understand Quranic context (Science of <em>Munasabah</em>).",
        "tc_biqai_title": "👳‍♂️ Imam Burhan al-Din al-Biqai (d. 885 H)",
        "tc_biqai_intro": "He is a great <em>Mufassir</em> who wrote the famous Tafsir <strong>\"Nazm al-Durar\"</strong>. His uniqueness? He extensively quoted Torah and Gospel verses to show coherence with the Quran. When criticized, he wrote a defense titled <em>\"Al-Aqwal al-Qawimah\"</em>:",
        "tc_quote_block": "\"The correspondence between the Al-Quran and previous Scriptures is proof of truth... Quoting them for the purpose of verifying and explaining is praiseworthy, not blameworthy.\"",
        "tc_biqai_citation": "📚 <strong>Source:</strong> Saleh, Walid. <em>\"In Defense of the Bible\"</em> (Analysis of Al-Biqai's work).",
        ...
        "ti_intro": "The Quran gives exclusive titles to Jesus: <strong>\"Word of Allah\"</strong> and <strong>\"Spirit from Him\"</strong> (QS 4:171). This is not Trinity, but a beautiful truth according to Classical Tafsir.",
        "ti_quote_title": "👳‍♂️ Tafsir Fakhr al-Din al-Razi (Tafsir Al-Kabir)",
        "ti_quote_block": "\"He is named <strong>'Spirit'</strong> because he (Jesus) is the cause of life for the world in their religion... just as the spirit is the cause of life for the body. Allah made him a source of guidance that revives dead hearts.\"",
        "ti_razi_intro": "Regarding the title \"Spirit of Allah\", Imam Razi explains this does not mean Jesus is part of God's essence (like a biological son), but rather due to his function as a <strong>Giver of Spiritual Life</strong>:",
        "ti_razi_extra": "And regarding \"Word of Allah\", he explains that Jesus was created directly by the command <em>\"Kun\"</em> (Be), without a human father, making him a direct manifestation of the Creator's Will.",
        "ti_btn_source": "🔗 Check on Altafsir.com (Arabic)",
        ...
        "ti_conclusion_text": "If Great Scholars acknowledge Him as the \"Cause of Spiritual Life\" for the world, it is natural that the Gospel is filled with teachings that revive the heart. Have you drunk from this \"Water of Life\"?",

        // Topic: Light
        "tl_title": "Light of Perfect Ethics",
        "tl_subtitle": "Jesus in Ihya Ulumuddin",
        "tl_intro": "Imam Al-Ghazali (\"Proof of Islam\") often quotes the sayings of Jesus the Messiah in his masterpiece to teach tenderness of heart.",
        "tl_quote_title": "👳‍♂️ Quote from Imam Al-Ghazali",
        "tl_quote_block": "\"Jesus a.s. said: 'Do not sit with the dead, lest your hearts die.' They asked: 'Who are the dead?' He replied: 'Those who love the world.'\"",
        "tl_ghazali_intro": "Imam Al-Ghazali, the <em>Proof of Islam</em>, in his monumental work <strong>Ihya Ulumuddin</strong>, often quotes Prophet Isa a.s. as the pinnacle example of heart purity and asceticism.",
    ...
    "ko": {
        ...
        "wr_card1_text": "<p>\"믿는 자들은 <strong>알라께서 사도들에게 내리신 모든 성서</strong>를 믿으며... 그 중 어느 하나도 차별하지 않는다.\"</p>",
        ...
        "wr_card4_text": "<p>\"인질 안에는 <strong>진리로 이끄는 인도</strong>와, 의심과 문제의 어둠을 밝히는 빛이 있다.\"</p>",
        ...
        "tp_subtitle": "사히 알 부카리와 고전 타프시르의 관점",
        "tp_intro": "많은 무슬림은 이전 성서들이 완전히 변질(타흐리프)되었다고 생각합니다. 그러나 위대한 학자들은 <strong>타흐리프 알 라프즈</strong>(텍스트 변질)와 <strong>타흐리프 알 마나</strong>(해석 변질)를 구별했습니다. 꾸란이 말하는 것은 어느 쪽일까요?",
        "tp_quote_title": "👳‍♂️ 압둘라 이븐 압바스 r.a.의 견해",
        "tp_quote_text": "선지자의 사촌이자 <i>투르주만 알 꾸란</i>인 이븐 압바스는 <strong>사히 알 부카리</strong>에서 놀라운 견해를 제시합니다:",
        "tp_quote_block": "\"아무도 알라의 책에서 단 한 단어도 바꿀(지울) 수 없다. '바꾼다'(타흐리프)는 것은 <strong>해석을 바꾼다는 뜻(의미 왜곡)</strong>이지, 원문을 바꾼다는 뜻이 아니다.\"",
        "tp_conclusion_title": "이것이 왜 중요한가?",
        "tp_conclusion_text": "만약 원문이 보존되었다면(QS 6:115), \"변질\"은 과거 성직자들의 해석 오류일 뿐입니다. 이는 <strong>현재의 텍스트가 여전히 \"빛\"과 \"인도\"를 담고 있음</strong>을 의미합니다. 사해 사본 또한 이 보존성을 증명합니다.",
        "tp_citation_full": "📚 <strong>출처:</strong> <em>사히 알 부카리</em>, 키탑 아트-타우히드 (97권), 55장.<br>이 견해는 <strong>이맘 이븐 하자르 알-아스칼라니</strong>의 주석서 <em>Fath al-Bari</em>에서도 지지됩니다.",
        "tp_btn_source": "🔗 Sunnah.com 확인 (Bukhari 7535)",
        "tp_why_important_title": "이것이 왜 중요한가?",
        "tp_why_important_text": "만약 원문이 알라에 의해 보존되었다면(QS 6:115), \"변질\"은 과거 성직자들에 의한 해석의 왜곡일 뿐입니다. 이는 <strong>현재 존재하는 텍스트가 여전히 \"빛\"과 \"인도\"를 담고 있음</strong>을 의미합니다.",
        "tp_dead_sea_text": "20세기에 발견된 <strong>사해 사본(Dead Sea Scrolls)</strong>과 같은 고대 필사본들은 예언자 이사 a.s. 시대의 타우라트와 시편 텍스트가 오늘날 우리가 가진 것과 동일함을 증명하며, 대규모 텍스트 변질 이론을 반박합니다.",

        // Topic: Context
        "tc_title": "무슬림이 복음서를 읽어도 되는가?",
        "tc_subtitle": "시대를 관통한 학자들의 발자취",
        "tc_intro": "이전 성서(타우라트와 인질)를 읽는 것은 현대적 유행이 아니라, 꾸란의 맥락(무나사바)을 이해하기 위해 고전 학자들이 행해온 전통입니다.",
        "tc_biqai_title": "👳‍♂️ 이맘 부르한 알 딘 알 비카이 (사망 885 H)",
        "tc_biqai_intro": "그는 유명한 타프시르 <strong>\"Nazm al-Durar\"</strong>를 쓴 위대한 <em>무파시르</em>입니다. 그의 독특함은? 그는 꾸란과의 일치성을 보여주기 위해 타우라트와 인질 구절을 광범위하게 인용했습니다. 비판을 받았을 때 그는 <em>\"Al-Aqwal al-Qawimah\"</em>라는 변증서를 썼습니다:",
        "tc_quote_block": "\"알꾸란과 이전 성서들 사이의 일치는 진리의 증거이다... 진리를 입증하고 설명하기 위해 그것들을 인용하는 것은 칭찬받을 일이지, 비난받을 일이 아니다.\"",
        "tc_biqai_citation": "📚 <strong>출처:</strong> Saleh, Walid. <em>\"In Defense of the Bible\"</em> (알 비카이의 저작 분석).",
        ...
        "ti_intro": "알꾸란은 이사 a.s.에게 <strong>\"알라의 말씀\"</strong>과 <strong>\"그로부터 온 영\"</strong>(QS 4:171)이라는 독점적인 칭호를 부여합니다. 이는 삼위일체가 아니라, 고전 타프시르에 따른 아름다운 진리입니다.",
        "ti_quote_title": "👳‍♂️ 파크르 알 딘 알 라지 (타프시르 알 카비르)",
        ...
        "ti_razi_intro": "\"알라의 영\"이라는 칭호에 대해 이맘 라지는 이것이 이사가 신의 본선의 일부(생물학적 아들 같은)라는 뜻이 아니라, <strong>영적 생명의 수여자</strong>로서의 기능 때문이라고 설명합니다:",
        "ti_razi_extra": "또한 \"알라의 말씀\"에 대해서는, 인간 아버지를 통하지 않고 <em>\"Kun\"</em>(있으라)이라는 명령으로 직접 창조되었기에 창조주 의지의 직접적인 현현이라고 설명합니다.",
        "ti_btn_source": "🔗 Altafsir.com 확인 (아랍어)",
        "ti_razi_citation": "📚 <strong>출처:</strong> <em>타프시르 알 카비르 (Mafatih al-Ghayb)</em>, QS 4:171 해설.",
        "ti_conclusion_title": "생명의 원천",
        "ti_conclusion_text": "위대한 학자들이 그분을 세상의 \"영적 생명의 원인\"으로 인정한다면, 인질이 마음을 되살리는 가르침으로 가득 차 있는 것은 당연합니다. 이 \"생명수\"를 마셔보셨습니까?",
        ...
        "tl_quote_block": "\"이사 a.s.께서 말씀하셨다: '죽은 자들과 함께 앉지 말라. 너희 마음이 죽을까 하노라.' 그들이 물었다: '죽은 자들이 누구입니까?' 그가 답했다: '세상을 사랑하는 자들이다.'\"",
        "tl_ghazali_intro": "이맘 알 가잘리(\"이슬람의 증거\")는 그의 기념비적 저작인 <strong>이흐야 울룸무딘</strong>에서 마음의 순수함과 금욕(세상에 얽매이지 않음)의 최고의 모범으로 예언자 이사 a.s.의 말씀을 자주 인용합니다.",
